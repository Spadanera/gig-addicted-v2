...
import BandDetails from '@/components/band/Details.vue'
import BandEvent from '@/components/band/Event.vue'
import BandMember from '@/components/band/Member.vue'
import BandSetlist from '@/components/band/Setlist.vue'
